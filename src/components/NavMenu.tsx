...
function HorizontalNav({ label, href, subCategories }: NavProp) {
  ...
  return (
    <div
      className="relative py-2 text-gray-600 dark:text-gray-400"
      ref={menuRef}
      onBlur={handleBlur}
    >
      {hasSubCategories && (
...
function NavMenu(navMenu: NavMenuProp) {
  return (
    <div className="flex-start ml-8 flex flex-row place-items-end items-end justify-start gap-10 align-middle font-sans">
      <a
        href="#main-content"
        className="
