...
function People({ }) {
    return (
        ...
        <div className="rounded-lg border-x-2 border-gray-400 dark:border-medwork-light w-full my-6 py-6 sm:my-12 sm:py-12 px-4 flex overflow-x-auto space-x-8 snap-x snap-mandatory">
