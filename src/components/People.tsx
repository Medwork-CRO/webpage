...
function People({ }) {
    return (
        ...
        <div className="border-x-2 border-gray-300 dark:border-gray-500 w-full my-6 py-6 sm:my-12 sm:py-12 px-4 flex overflow-x-auto space-x-8 snap-x snap-mandatory">
