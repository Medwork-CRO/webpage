...
function CarouselImage({ image, title }: ImageShowCaseProps) {
  ...
  return (
    <div className="relative flex flex-col md:flex-row h-[95vh] sm:h-[60vh] flex-[0_0_100%] motion-safe:animate-fadeIn">
      <Image
        src={image}
      ...
      <div className="absolute bottom-8 sm:bottom-16 z-20 w-full mb-8 sm:mb-2">
        <div className="flex flex-col justify-center gap-8 max-w-[1376px] px-4 md:px-6 lg:px-0 mx-auto text-gray-500 dark:text-gray-400 text-left">
