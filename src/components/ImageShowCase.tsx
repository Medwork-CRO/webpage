...
function ImageShowCase({
  ...
  return (
    <div className="flex flex-col sm:flex-row h-[815px] w-full flex-[0_0_100%]">
      ...
      <div className="flex flex-col w-1/3 gap-8 sm:ml-16 text-gray-500 dark:text-gray-400">
        ...
        <span className="text-center text-xl font-semibold md:text-3xl xl:text-5xl">
          {description}
        </span>
