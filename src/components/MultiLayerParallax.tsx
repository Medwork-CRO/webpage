...
function MultiLayerParallax({
    ...
    return (
        ...
        >
            <motion.h1
                style={{ y: textY }}
                className="font-bold mb-[18rem] xs:mb-[32rem] text-white text-7xl md:text-[12rem] relative z-10"
            >
                {text}
            </motion.h1>
            ...
            <div
                className={`absolute inset-0 z-5 from-[#f6f1eb] dark:from-[#2d333b] to-transparent bg-gradient-to-t`}
            ></div>
        </div>
    );
}
