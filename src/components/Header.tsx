...
function Header() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[1476px] px-4 py-3 sm:py-4 lg:px-0 items-center justify-between">
        <Logo />
        <button
      ...
      <motion.div className="mx-auto max-w-[1476px] top-0 left-0 right-0 h-[0.2rem] bg-cyan-500 origin-center " style={{ scaleX: scrollYProgress }} />
    </header>
  );
}
