...
function ImageCategory({
    ...
    return (
        <div className="relative flex flex-col md:flex-row] w-full flex-[0_0_100%] motion-safe:animate-fadeIn justify-center">
            <Image
                src={image}
                className="h-[50vh] w-full object-cover eq:rounded-xl"
                alt="alt"
            />
            ...
            <div className="absolute bottom-8 sm:bottom-16 z-20 w-full mb-8 sm:mb-2">
                <div className="flex flex-col justify-center gap-8 w-full max-w-[1200px] px-4 md:px-6 eq:px-0 mx-auto text-gray-700 dark:text-gray-300 text-start">
