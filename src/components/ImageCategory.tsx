...
function ImageCategory({
  ...
  return (
    <>
      <div className="relative w-full md:flex-row h-screen hidden md:block motion-safe:animate-fadeIn">
        <Image
          src={image}
        ...
        <div className="absolute top-3/4 z-20 -translate-y-1/2 transform w-full">
          <div className={`flex flex-col justify-center gap-8 px-4 md:px-6 lg:px-0 max-w-[86rem] mx-auto ${!textSide || textSide === "left"
            ? "text-left"
            : "text-right"
            }`}>
