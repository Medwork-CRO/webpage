...
const paragraphs = [
  "We can develop, improve, and monitor your QMS to ensure alignment with industry standards and regulations.",
];
...
const showcases = [
  {
    ...
    point:
      "We customize processes to align with standardized practices, ensuring compliance with legal and regulatory requirements, and relevant quality standards.",
  },
  {
    title: "Review and Improvement of Existing QMS",
    point:
      "We assess your existing QMS for compliance, effectiveness, and efficiency. Our experts provide detailed insights, highlighting areas of strength and opportunities for improvement. This strategic evaluation ensures that your QMS continues to evolve, meeting the dynamic demands of industry standards.",
  },
  {
