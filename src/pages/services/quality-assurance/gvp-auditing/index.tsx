...
const paragraphs = [
  "Whether it's strengthening your internal processes or ensuring compliance across external partnerships, our GVP auditing services are tailored to address the dynamic needs of the pharmaceutical industry. Our auditing offerings cover both internal and Vendor/External partner audits.",
];
