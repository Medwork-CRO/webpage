...
const title = "Our local QA experts work closely with your team to oversee and manage the QA aspects of your PV processes";
const showcases = [
    {
        title: "",
...
function CaseProcessing() {
    return (
        <div className="mx-auto flex flex-col items-center justify-between w-full">
            <ImageCategory image={safety} title="QA  PERSONNEL" />
