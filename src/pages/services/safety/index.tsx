...
const showcases = [
  ...
  {
    title:
      "Local pharmacovigilance contact / Qualified Person (Greece, Cyprus, Malta)",
    point: "",
  },
  {
    title:
      "Development and maintenance of pharmacovigilance systems and Pharmacovigilance System Master File (PSMF) ",
    point: "",
  },
  { title: "Management of case reports ", point: "" },
  {
    title:
      "Signal management activities (including monitoring of EudraVigilance data via EudraVigilance Data Analysis System (EVDAS))",
    point: "",
  },
  {
    title:
      "Preparation and submission of aggregate reports (Periodic Safety Update Report (PSUR), Addendum to Clinical Overviews (ACO))",
    point: "",
  },
  {
    title: "Creation/review and maintenance of Risk Management Plan (RMP)",
    point: "",
  },
  {
    title:
      "Handling safety communications (Direct Healthcare Professional Communication (DHPC), educational material)",
    point: "",
  },
  {
    title:
      "Implementation of additional Risk Minimization Measures (aRMM; including Pregnancy Prevention Programme (PPP))",
    point: "",
  },
  { title: "Local and global literature monitoring", point: "" },
  {
    title:
      "Local (Greece, Cyprus, Malta) and EU pharmacovigilance regulatory intelligence",
    point: "",
  },
  {
    title:
      "Submission of data to Extended EudraVigilance Medicinal Product Dictionary (XEVMPD)",
    point: "",
  },
  {
    title:
      "Clinical trial pharmacovigilance (including EudraVigilance registration and provision of Responsible Person, management of Serious Adverse Event (SAE) / Suspected Unexpected Serious Adverse Reaction (SUSAR), Development Safety Update Report (DSUR) preparation and submission, literature monitoring)",
    point: "",
  },
