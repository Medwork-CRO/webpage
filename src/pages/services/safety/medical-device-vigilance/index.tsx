...
const showcases = [
  {
    ...
    point:
      "Our transition to medical device vigilance is not merely a new venture; it signifies an evolution of our legacy. The same dedication that has propelled our journey in pharmacovigilance now forms the foundation of our approach to medical devices.",
  },
  {
    title: "Consistent Standards",
    point:
      "Just as we have upheld uncompromising standards in pharmacovigilance, we apply the same level of rigour and precision to our medical device vigilance services.",
  },
  {
    title: "Holistic Expertise",
    point:
      "Our multidisciplinary team harnesses insights from both the pharmacovigilance and medical device fields, cultivating a comprehensive approach across the spectrum of safety concerns.",
  },
  {
    title: "Unified Vigilance",
    point:
      "Regardless of whether it's pharmaceuticals or medical devices, our paramount goal remains the same: to safeguard patient well-being and ensure regulatory compliance.",
  },
];
