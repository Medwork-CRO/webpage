...
const showcases = [
  {
    ...
    point:
      "Despite our relatively young presence, our focus on clinical trial safety is steadfast. We approach each project with an eagerness to learn and a dedication to delivering results.",
  },
  {
    title: "Collaborative Adaptation",
    point:
      "We understand the unique demands of clinical trial safety. By collaborating closely with your team, we tailor our approach to meet your specific requirements.",
  },
  {
    title: "Growing experience",
    point:
      "With a history of clinical trial PV execution in over 10 countries, our experience is steadily growing and extending to encompass various territories.",
  },
];
