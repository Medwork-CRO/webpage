...
const showcases = [
    {
        ...
        point: "Our skilled team of pharmacovigilance experts is committed to efficient and accurate ICSR handling, ensuring meticulous attention to detail.",
    },
    {
    ...
    },
    {
        ...
        point: "Leveraging our PV database and extensive experience with major PV databases, we ensure case processing tailored to your specific needs.",
    },
    {
    ...
    },
    {
        ...
        point: "Clients benefit from our comprehensive three-step approach, encompassing initial processing, expert medical assessment by qualified medical doctors, and thorough quality control checks by experienced PV personnel.",
    },
];
