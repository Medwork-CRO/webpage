...
const showcases = [
  {
    ...
    point:
      "Outsourcing your pharmacovigilance personnel allows you to control costs effectively, eliminating the need for extensive in-house resources.",
  },
  {
    title: "Quality Assurance",
    point:
      "Our team is dedicated to maintaining the highest quality standards, ensuring accurate and timely pharmacovigilance activities.",
  },
  {
    title: "Focus on Core Competencies",
    point:
      "Free up your internal resources to concentrate on core business activities, while we handle the intricacies of pharmacovigilance.",
  },
  {
    title: "Proven Track Record",
    point:
      "We have a successful track record of providing pharmacovigilance solutions to a diverse range of pharmaceutical companies.",
  },
];
...
function Outsourcing() {
  return (
    <div className="mx-auto flex flex-col items-center justify-between w-full">
      <ImageCategory image={outsourcing} title="Outsourcing" description="" />
      ...
      >
        ...
        <div className="flex flex-col gap-20 sm:gap-24 md:gap-28 px-4 sm:px-6 eq:px-0 py-16">
          ...
          <DisplayParagraphs
            withLead={true}
            paragraphs={customSolutionsParagraph}
          />
