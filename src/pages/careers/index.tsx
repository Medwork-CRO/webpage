...
import RoundedButtonExternal, {
  ButtonType,
} from "@/components/RoundedButtonExternal";
import Showcasing from "@/components/Showcasing";
import Title from "@/components/Title";
// import careers from "@assets/services/careers.webp";
import careers from "@assets/stock-images/careers.webp";
...
const showcases = [
  {
    ...
    point:
      "We believe in the power of continuous learning and understand the importance of investing in the next generation. Whether you're a recent graduate or someone exploring new horizons, we've got robust training programmes to ensure you're well-prepared for the exciting journey ahead.",
  },
  {
    title: "Prospects for Professional Development",
    point:
      "We offer a dynamic environment that encourages innovation, creativity, and personal growth. Our commitment to your success extends beyond your initial role, providing clear pathways for professional development as you shape your career with us.",
  },
  {
    title: "A Vibrant Community of Young Professionals",
    point:
      "Join a company that thrives on the energy and enthusiasm of its young workforce. At Medwork, you'll be surrounded by like-minded individuals who share a passion for excellence and making a difference. Collaborate, connect, and celebrate together in a vibrant community that values fresh perspectives.",
  },
  {
    title: "Learn from the Best in the Field",
    point:
      "At Medwork, we believe in learning from the best to become the best. Join our team and become part of the leading pharmacovigilance service provider in Greece.",
  },
];
...
function Careers() {
  ...
  return (
    <div className="mx-auto flex flex-col items-center justify-between w-full">
      <ImageCategory image={careers} title="Careers" description="" />
            ...
            <div className="my-6 flex flex-col gap-6 items-center">
              <div className="mt-4 flex flex-col sm:flex-row justify-center items-center gap-6 text-center w-full">
                <RoundedButtonExternal
                  ...
                  href={`mailto:${hrEmail}`}
                  ariaLabel={
                    "By clicking you will be taken to compose an email to medwork hr"
                  }
