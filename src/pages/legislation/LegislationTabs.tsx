...
const legislations: Legislation[] = [
    {
        ...
        dropDowns: [
            {
                title: "Questions and Answers regarding the local implementation of Regulation (EU) No 536/2014 (CTR) in Greece",
            ...
            {
                title: "Circular regarding the management and reporting of safety issues in the context of conducting clinical trials",
            ...
            },
            {
                ...
                content: "The \"Yellow Card\", is used to collect information on adverse drug reactions. Healthcare professionals and patients can use it to report adverse drug reactions to the National Organization for Medicines (EOF). It can be sent via fax or regular mail. Alternatively, adverse drug reactions may be reported electronically via EOF's site. For more information visit: https://www.eof.gr/web/guest/yellowgeneral.",
                filePath: "pdfs/legislation/greek-pharmacovigilance",
                fileNameGR: "Yellow card.pdf",
            },
            {
                title: "Ministerial Decision 3a/90023, published in Government Gazette issue 2485/B/03-10-2013",
                content: "Transposition of Directive 2012/26/EU of the European Parliament and of the Council of 25 October 2012 into Greek law, amending Directive 2001/83/EC as regards pharmacovigilance. It applies in conjunction with the \"Ministerial Decision No. 3a / G.P.\",32221/29-04-2013.",
                filePath: "pdfs/legislation/greek-pharmacovigilance",
            ...
            },
            {
                ...
                content: "Transposition of EU Directive 2001/83/EC into Greek law, concerning the production and the marketing of medicinal products for human use, as applicable and as amended by the EU Directive 2011/62 regarding the prevention of falsified medicines in the legal supply chain (L 174/01-07-2011).",
                filePath: "pdfs/legislation/greek-pharmacovigilance",
    ...
    },
    {
        ...
        dropDowns: [
            {
                title: "Pharmaceutical Services - Ministry of Health Announcement 03-02-2016",
                content: "Announcement regarding submission through Common European Submission Platform (CESP)",
            ...
            {
                title: "Pharmaceutical Services - Ministry of Health Announcement 25-10-2013",
                content: "Announcement regarding \"Dear Health Care Professional (DHPC)\" communications",
                filePath: "pdfs/legislation/cypriot-pharmacovigilance",
    ...
    },
    {
        ...
        dropDowns: [
            {
                title: "Regulation (EU) 2017/746 of the European Parliament and of the Council of 5 April 2017 on in vitro diagnostic medical devices and repealing Directive 98/79/EC and Commission Decision 2010/227/EU",
                content: "",
            ...
            {
                title: "Guidelines on a Medical Device Vigilance System_revision January 13",
                content: "EU Guidelines on a Medical Device Vigilance System _MEDDEV 2.12-1 revision 8/January 2013",
                filePath: "pdfs/legislation/greek-materiovigilance",
                fileNameEN: "MEDDEV_2.12-1_ rev8_Jan13.pdf",
            },
            {
                title: "Summary of the Obligations for manufacturers and operators of Medical Devices (Version 1.0/April 2010)",
                content: "",
                filePath: "pdfs/legislation/greek-materiovigilance",
