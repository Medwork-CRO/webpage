      ...
      <article className="post-content page-template no-image">
        <div className="post-content-body">
          ...
          <Tabs>
            ...
            <TabPanel>
              <p>
                <i>Nicolas Tsiakkas, M.D.</i> has been an active member of the pharmaceutical industry for over 30 years, gaining deep knowledge and expertise across a wide range of pharmacovigilance, clinical development and quality assurance activities.
                Following his qualification as a physician at the Medical School of Wuerzburg in Germany and his specialization in ophthalmology, he started his career in 1989 with Schering-Plough, Greece,
                holding the position of Medical Director. He then moved to Rhone-Poulenc Rorer as the Regional Medical Director and Pharmacovigilance Manager, being responsible for the company's
                research programme from Phase II through to Phase IV studies in Greece, Bulgaria, Romania and Serbia. Following the merger of Rhone-Poulenc Rorer with Hoechst-Marion-Roussel, he served as a Medical Director and Pharmacovigilance Manager with Aventis Pharma, Greece, between 2000 and 2005.
                In 2005, he founded Medwork, which, under his leadership, has grown from a company focusing primarily on clinical research to a leading Vigilance service provider in Europe.
                Nicolas is the Head of the Pharmacovigilance Working Group of the European CRO Federation (EUCROF). Since 2019, he is also a member of the organizing committee for the DIA EU-QPPV annual meetings.
              </p>
            </TabPanel>
            <TabPanel>
              <p>
                <i>Eleni Voidou</i> has over 16 years successful experience in management within the healthcare industry. After earning a degree in Physics from the University of Thessaloniki, she went on to obtain a Master's Degree in Biomedical Engineering at Imperial College, London.
                She then spent 11 years in the medical device industry, serving in both operational and management roles. In 2009 Eleni joined Medwork, assuming the position of Administration Director. Her responsibilities, besides administrative functions within the company, include business development and interaction with clients.
              </p>
            </TabPanel>
            <TabPanel>
              <p>
                <i>Katerina Paschou</i> graduated from the National and Kapodistrian University of Athens with a bachelor's degree in Dentistry (DDS). She practiced Dentistry for two years and in 2009 she joined Medwork, taking up the position of Pharmacovigilance Assistant. Since then, Katerina has been gradually taking responsibility for a variety of complex and difficult tasks, among which have been assuming the roles of EU Qualified Person for Pharmacovigilance (QPPV) and Local Pharmacovigilance Contact Person. She has also served as a substitute Drug Safety Manager at Roche Hellas for a period of six months in 2011.
